  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 border-b border-white/10 bg-obsidian/70 px-5 backdrop-blur-2xl sm:px-8">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between">
        <Link href="/" className="flex items-center gap-3" aria-label="Trang chủ Egoric Agency">
          <Image
        ...
        <nav className="hidden items-center gap-7 text-sm font-medium text-silver lg:flex">
          {navItems.map((item) => (
        ...
        <Link
          href="/contact"
          className="button-shine hidden rounded-full border border-champagne/40 px-5 py-3 text-sm font-semibold text-bone shadow-glow transition hover:border-champagne lg:inline-flex"
        >
